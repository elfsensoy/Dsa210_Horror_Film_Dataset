...
Finnaly the Most reviewed Movies are:
- The Mummy,
- The Psycho,
- Halloween,
- The Predator
...
I thought that by turning sentiment classes into numeric values such as: (negative=0, neutral=1, positive=2), Anova would be the easiest way to compare the average sentiment between two groups.

2) Pearson Correlation: (Sentiment vs IMDb Rating)
To understand whether emotional reactions in reviews relate to how well the movie performs, I compared each film's average sentiment to is IMDb ratings.
